  ...
  return (
    <TooltipProvider>
      <div className="max-w-4xl mx-auto">
        ...
        <div className={`sticky ${isAuthenticated ? 'top-2' : 'top-28'} sm:top-16 z-40 bg-background/80 backdrop-blur-sm transition-transform duration-300 ease-out mb-3 sm:mb-6 ${
