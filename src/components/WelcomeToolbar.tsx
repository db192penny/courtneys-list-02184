      ...
      <Alert className="border-green-500 bg-green-50 relative shadow-md">
        ...
        <div className="pr-8">
          <AlertDescription className="text-sm leading-relaxed text-green-900">
            <strong>Welcome aboard!</strong> Start rating providers to help neighbors and earn points! Just 3 provider ratings gets you a $10 Starbucks gift card - coffee on us! ☕
          </AlertDescription>
        </div>
        <Button
          variant="ghost"
