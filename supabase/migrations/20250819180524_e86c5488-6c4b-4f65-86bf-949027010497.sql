-- Update list_vendor_stats function to include pet grooming in service call categories
...
AS $function$
  ...
  SELECT
    ...
    CASE 
      ...
      WHEN lower(v.category) IN ('plumbing', 'electrical', 'pet grooming') THEN
        CASE WHEN sc.service_call_avg IS NOT NULL THEN 'per Visit' ELSE 'See in Reviews' END
    ...
    CASE 
      ...
      WHEN lower(v.category) IN ('plumbing', 'electrical', 'pet grooming') THEN sc.service_call_avg
