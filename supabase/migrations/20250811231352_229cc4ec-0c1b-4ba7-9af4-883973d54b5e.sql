-- Retry migration without updating users to avoid trigger error
...
-- 3) Grant HOA admin to db@fivefourventures.com for Boca Bridges
...
-- 4) Grant site admin role to db@fivefourventures.com (for managing users)
