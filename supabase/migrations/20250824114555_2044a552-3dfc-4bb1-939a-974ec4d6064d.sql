...
-- Step 1: Remove only point-related triggers (not all triggers)
...
-- Step 2: Drop only point-related functions (keeping all other functions)
...
-- Step 3: Ensure correct point triggers exist (only touching point-related ones)

-- Vendor submission points trigger (5 points)
...
-- Review submission points trigger (5 points)
...
-- Step 4: Clean up only previous point correction entries
