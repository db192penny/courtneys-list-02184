-- Drop and recreate the list_vendor_reviews function to use cleaned street names
DROP FUNCTION IF EXISTS public.list_vendor_reviews(uuid);
...
-- Drop and recreate the list_vendor_costs function to use cleaned street names
DROP FUNCTION IF EXISTS public.list_vendor_costs(uuid);
