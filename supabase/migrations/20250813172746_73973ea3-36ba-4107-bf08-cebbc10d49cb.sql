-- Update the list_vendor_stats function to support category-specific cost aggregation
...
AS $function$
  ...
  -- Get all distinct addresses that have interacted with each vendor
  homes AS (
    ...
    FROM (
      ...
      -- Addresses from vendor creators
  ...
  SELECT
    ...
    CASE 
      ...
      WHEN lower(v.category) = 'hvac' THEN
