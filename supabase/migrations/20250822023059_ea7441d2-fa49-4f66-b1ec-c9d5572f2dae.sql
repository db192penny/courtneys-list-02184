-- Update list_vendor_stats function to include house cleaning in service call category logic
...
AS $function$
  ...
  homes AS (
    ...
    FROM (
      -- Only count homes that currently use the vendor (from home_vendors table)
