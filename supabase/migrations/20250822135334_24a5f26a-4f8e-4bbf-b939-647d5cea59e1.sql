-- Fix the handle_new_user trigger to handle duplicate emails gracefully
...
BEGIN
  ...
  -- Use ON CONFLICT to handle cases where email might already exist
  INSERT INTO public.users (
    ...
    -- Update existing user if email already exists (for re-registration case)
    id = EXCLUDED.id,
